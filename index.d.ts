...
export declare class Call extends TypedEventEmitter<CallEventMap> {
   ...
   * ```
   */
  enableVideo(videoEnabled: boolean): Promise<void>;
  /**
   ...
   * ```
   */
  getAvailableAudioDevices(): Promise<MediaDeviceInfo[]>;
  /**
...
export declare class SceytCallClient extends TypedEventEmitter<CallClientEventMap> {
   ...
   * ```
   */
  join: (options: IJoinCallOptions) => Call | null;
  /**
   ...
   * ```
   */
  reject: (call: Call, reason?: string) => void;
  /**
...
export { SceytCallClient as default };
